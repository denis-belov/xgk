...
// void m4_mul32 (Mat4* m0, Mat4* m1, Mat4* m2) {
//   SET32(
//     m0,
...
// #define dot(row, col) _mm_dp_ps(rows[row], m2->_128[col], 0xff)[0]

// void m4_mul128 (Mat4* m0, Mat4* m1, Mat4* m2) {
//   const __m128 rows[4] = {
...
// // void m4_mul256 (Mat4* m0, Mat4* m1, Mat4* m2) {
// //   const __m256 a = _mm256_dp_ps(m1->_256[0], m2->_256[0], 0xff);
// //   const __m256 b = _mm256_dp_ps(m1->_256[0], m2->_256[1], 0xff);
// //   const __m256 c = _mm256_dp_ps(m1->_256[1], m2->_256[0], 0xff);
// //   const __m256 d = _mm256_dp_ps(m1->_256[1], m2->_256[1], 0xff);

// //   const __m256 _0 = _mm256_set_m128(m1->_128[0], m1->_128[1]);
// //   const __m256 _1 = _mm256_set_m128(m1->_128[2], m1->_128[3]);

// //   const __m256 e = _mm256_dp_ps(_0, m2->_256[0], 0xff);
// //   const __m256 f = _mm256_dp_ps(_0, m2->_256[1], 0xff);
// //   const __m256 g = _mm256_dp_ps(_1, m2->_256[0], 0xff);
// //   const __m256 h = _mm256_dp_ps(_1, m2->_256[1], 0xff);
...
static inline void m4_premul32 (Mat4* m0, Mat4* m1) {
  SET32(
    m0,
...
void m4_premul256 (Mat4* m0, Mat4* m1) {
...
// void m4_postmul32 (Mat4* m0, Mat4* m1) {
//   SET32(
//     m0,
...
// void m4_postmul128 (Mat4* m0, Mat4* m1) {
//   const __m128 rows[4] = {
//     _mm_setr_ps(m1->_32[0], m1->_32[4], m1->_32[8] , m1->_32[12]),
//     _mm_setr_ps(m1->_32[1], m1->_32[5], m1->_32[9] , m1->_32[13]),
//     _mm_setr_ps(m1->_32[2], m1->_32[6], m1->_32[10], m1->_32[14]),
...
// // void m4_postmul256 (Mat4* m0, Mat4* m1) {
...
// void m4_muls32 (Mat4* m, const float s) {
...
// void m4_muls128 (Mat4* m, const float s) {
...
// // void m4_muls256 (Mat4* m, const float s) {
...
//   const float zoom
// ) {
//   const float top = near * tan(0.017453292f * 0.5f * fov) / zoom;
...
// void m4_makeRot32 (Mat4* m0, Quat* q0) {
...
// void m4_makeRot128 (Mat4* m0, Quat* q0) {
//   const float xx = 2.0f * q0->_32[0] * q0->_32[0];
//   const float yy = 2.0f * q0->_32[1] * q0->_32[1];
//   const float zz = 2.0f * q0->_32[2] * q0->_32[2];
//   const float xy = 2.0f * q0->_32[0] * q0->_32[1];
...
// // void m4_makeRot256 (Mat4* m0, Quat* q0) {
// //   const float xx = 2.0f * q0->_32[0] * q0->_32[0];
// //   const float yy = 2.0f * q0->_32[1] * q0->_32[1];
// //   const float zz = 2.0f * q0->_32[2] * q0->_32[2];
// //   const float xy = 2.0f * q0->_32[0] * q0->_32[1];
...
// void m4_makeRotX32 (Mat4* m0, const float angle) {
...
// void m4_makeRotX128 (Mat4* m0, const float angle) {
//   const float cos_ = cos(angle);
//   const float sin_ = sin(angle);
...
// // void m4_makeRotX256 (Mat4* m0, const float angle) {
// //   const float cos_ = cos(angle);
// //   const float sin_ = sin(angle);
...
// void m4_makeTrans32 (Mat4* m0, Vec4* axis, const float value) {
//   SET32(
//     m0,
...
// void m4_makeTrans128 (Mat4* m0, Vec4* axis, const float value) {
//   SET128(
//     m0,
...
// // void m4_makeTrans256 (Mat4* m0, Vec4* axis, const float value) {
// //   SET256(
// //     m0,
...
// void m4_makeTrans128_ (Mat4* m0, Vec4* axis, const float value) {
//   m4_reset(m0);
...
// //   m4_makeProjPersp_ = m4_makeProjPersp256_;
